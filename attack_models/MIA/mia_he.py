...
def evaluate_mia_at_modulus_degrees(modulus_degrees, dataset_train, dataset_test, dict_users, args):
    mia_results = {}
    for degree in modulus_degrees:
        print(f"\nEvaluating MIA at polynomial modulus degree: {degree}")
        args.poly_modulus_degree = degree  # Set the polynomial modulus degree
