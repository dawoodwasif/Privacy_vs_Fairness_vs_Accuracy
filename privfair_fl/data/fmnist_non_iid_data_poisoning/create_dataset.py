...
def apply_data_poisoning(y_train, poison_rate=0.1):
    ...
    for idx in poisoned_indices:
        # Flip the label to a random incorrect label within the specified classes
        original_label = y_train[idx]
        possible_labels = [label for label in range(3) if label != original_label]
...
def main():
    ...
    # Apply data poisoning to training labels
...
if __name__ == "__main__":
    print("Creating non-IID dataset with data poisoning...")
    main()
